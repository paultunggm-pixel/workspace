...
链路 B 脚本：`~/Desktop/qianwen-cover-generator/`（见 `挂载压图分支说明.md`）  
...
- 工程：`~/Desktop/qianwen-cover-generator/`
- **style3 单名**（语文 / 科普 / 妙题）：
...
| 演进日志 | `.../logs/项目演进记录.md` |
| 挂载压图（真源） | `~/Desktop/qianwen-cover-generator/render_covers.py` |
| 挂载压图脚本索引 | `.../scripts-索引/挂载压图脚本.md` |
| 数学压图（旧 API） | `output/cover-generator/refs/render_covers.py` |
| 普惠体/元黑字体 | `output/cover-generator/assets/` |
| 挂载压图备份 | `output/cover-generator/_qcg/qianwen-cover-generator/` |
